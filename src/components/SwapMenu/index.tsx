...
const SwapMenu = () => {
  ...
  return (
    <div className="text-text-light dark:text-text-dark ">
      <div className="relative z-10 mx-auto mt-16 text-center h-auto w-full max-w-md rounded-3xl bg-bg-card-light p-7 pt-6 shadow-card dark:bg-bg-card-dark dark:shadow-card-dark">
        <div className="mb-[27px] text-2xl font-bold">Swap</div>
        <SwapInput
          {...{
            value: payAmount,
            setPayAmount,
