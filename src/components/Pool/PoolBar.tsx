...
const PoolBar = ({ image1, image2, ticker1, ticker2, liquidity, volume, fees, apr }: PoolBarProps) => {
    return (
        <Link href="/">
            <div className="font-[Montserrat] text-[0.5rem] cursor-pointer select-none md:mx-auto md:max-w-5xl md:p-0 md:text-base h-12 md:max-width mt-4 overflow-hidden rounded-lg shadow-card 
