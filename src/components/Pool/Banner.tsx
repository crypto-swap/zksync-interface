...
const style = {
    ...
    liquidity: `relative hidden rounded-xl card px-[30px] pt-[30px] pb-9 dark:card-dark md:block shadow-card dark:shadow-card-dark`,
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.liquidity}>
                <div className="text-lg font-medium">Add Liquidity</div>
                <div className="relative mt-2.5 w-2/3 text-gray-500 dark:text-dark-500">
                    When you Add Liquidity, you receive LP tokens which represent your share of the total pool.
                </div>
                ...
                <div className={style.zapText}>
                    <div>
                        ...
                        <div className="mt-2 text-gray-500 dark:text-dark-500">
                            Zap will turn one token into a liquidity pair!
                        </div>
                    </div>
                    <div>
