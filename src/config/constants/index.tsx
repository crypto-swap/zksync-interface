import { ChainId, JSBI, Percent, Token } from '@crypto-swap/sdk'
import { BigNumber } from '@ethersproject/bignumber'
import { testnetTokens } from './tokens'

export const ROUTER_ADDRESS = {
    //[ChainId.TESTNET]: '0xRouterAddressHere',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
    [ChainId.TESTNET]: [testnetTokens.eth, testnetTokens.usdc],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
    [ChainId.TESTNET]: [
        [testnetTokens.eth, testnetTokens.usdc]
    ],
}
